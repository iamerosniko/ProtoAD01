...
namespace API.Controllers
{
    ...
    public class FirmDemographicsController : Controller
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetFirmDemographics([FromRoute] Guid id)
        {
        ...
        public async Task<IActionResult> PostFirmDemographics([FromBody] FirmDemographics firmDemographics)
        {
            ...
            return CreatedAtAction("GetFirmDemographics", new { id = firmDemographics.FirmDemographicID }, firmDemographics);
        }
